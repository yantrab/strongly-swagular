...
import { FloorValueSettings } from '../models/floor-value-settings';
...
import { SettingsChangeItem } from '../models/settings-change-item';
import { TimingSettings } from '../models/timing-settings';
import { YesNoQuestionsSettings } from '../models/yes-no-questions-settings';
...
export class PanelService extends BaseService {
   ...
   */
  static readonly DeletePath = '/panel/{id}/delete';
  /**
  ...
  delete(id: number): Observable<void> {
    const rb = new RequestBuilder(this.rootUrl, PanelService.DeletePath, 'get');
