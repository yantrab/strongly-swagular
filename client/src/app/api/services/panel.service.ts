...
import { AddPanelDetailsDto, AddPanelDetailsDtoSchema } from '../models/add-panel-details-dto';
import { ChangeItem, ChangeItemSchema } from '../models/change-item';
import { Contact, ContactSchema } from '../models/contact';
import { Contacts, ContactsSchema } from '../models/contacts';
import { FloorValueSettings, FloorValueSettingsSchema } from '../models/floor-value-settings';
import { GeneralSettings, GeneralSettingsSchema } from '../models/general-settings';
import { PanelDetails, PanelDetailsSchema } from '../models/panel-details';
import { Settings, SettingsSchema } from '../models/settings';
import { SettingsChangeItem, SettingsChangeItemSchema } from '../models/settings-change-item';
import { TimingSettings, TimingSettingsSchema } from '../models/timing-settings';
import { YesNoQuestionsSettings, YesNoQuestionsSettingsSchema } from '../models/yes-no-questions-settings';
...
export const updateContactFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
...
export const reDumpFormGroupSchema = {
  properties: {
    dump: { type: 'string' },
    panel: { $ref: '#/components/schemas/PanelDetails' }
  },
  type: 'object',
  required: ['dump', 'panel']
};
...
export const updateContactsFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
      items: { $ref: '#/components/schemas/ChangeItem' }
  ...
  type: 'object',
  required: ['changes', 'contacts', 'panelId']
};
...
export const generalSettingsFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
      items: { $ref: '#/components/schemas/SettingsChangeItem' }
    },
...
export const timingSettingsFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
      items: { $ref: '#/components/schemas/SettingsChangeItem' }
    },
    settings: { $ref: '#/components/schemas/TimingSettings' }
  },
  type: 'object',
  required: ['changes', 'settings']
};
...
export const yesNoSettingsFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
      items: { $ref: '#/components/schemas/SettingsChangeItem' }
    },
    settings: { $ref: '#/components/schemas/YesNoQuestionsSettings' }
  },
  type: 'object',
  required: ['changes', 'settings']
};
...
export const floorSettingsFormGroupSchema = {
  properties: {
    changes: {
      type: 'array',
      items: { $ref: '#/components/schemas/SettingsChangeItem' }
    },
    settings: { $ref: '#/components/schemas/FloorValueSettings' }
  },
  type: 'object',
  required: ['changes', 'settings']
};
...
export class PanelService extends BaseService {
  ...
  logs_1(id: number): Observable<Array<any>> {
  ...
  list(): Observable<Array<PanelDetails>> {
  ...
  addNewPanel(addPanelDetailsDto: AddPanelDetailsDto): Observable<PanelDetails> {
    const rb = new RequestBuilder(this.rootUrl, PanelService.AddNewPanelPath, 'post');

    rb.body(addPanelDetailsDto, 'application/json');
  ...
  savePanel(panelDetails: PanelDetails): Observable<PanelDetails> {
    const rb = new RequestBuilder(this.rootUrl, PanelService.SavePanelPath, 'post');

    rb.body(panelDetails, 'application/json');
  ...
  contacts(id: number): Observable<Contacts> {
  ...
  settings(id: number): Observable<Settings> {
  ...
  dump(query?: PanelDetails): Observable<string> {
  ...
  updateContacts(body: { changes: Array<ChangeItem>; contacts: Array<Contact>; panelId: number }): Observable<any> {
  ...
  addNewPanelFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof AddNewPanelFormGroupType & string)[] },
    value?: AddNewPanelFormGroupType
  ) {
  ...
  savePanelFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof SavePanelFormGroupType & string)[] },
    value?: SavePanelFormGroupType
  ) {
  ...
  updateContactFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof UpdateContactFormGroupType & string)[] },
    value?: UpdateContactFormGroupType
  ) {
  ...
  reDumpFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof ReDumpFormGroupType & string)[] },
    value?: ReDumpFormGroupType
  ) {
  ...
  updateContactsFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof UpdateContactsFormGroupType & string)[] },
    value?: UpdateContactsFormGroupType
  ) {
  ...
  generalSettingsFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof GeneralSettingsFormGroupType & string)[] },
    value?: GeneralSettingsFormGroupType
  ) {
  ...
  timingSettingsFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof TimingSettingsFormGroupType & string)[] },
    value?: TimingSettingsFormGroupType
  ) {
  ...
  yesNoSettingsFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof YesNoSettingsFormGroupType & string)[] },
    value?: YesNoSettingsFormGroupType
  ) {
  ...
  floorSettingsFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof FloorSettingsFormGroupType & string)[] },
    value?: FloorSettingsFormGroupType
  ) {
