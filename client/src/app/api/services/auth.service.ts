...
export const loginFormGroupSchema = {
...
export class AuthService extends BaseService {
  ...
  setPassword(params: { token: string; body: { rePassword: string; password: string; email: string } }): Observable<boolean> {
    return this.setPassword$Response(params).pipe(map((r: StrictHttpResponse<boolean>) => r.body as boolean));
  }
  ...
  setPasswordFormModel(
    options?: Partial<FormModel> & { displayProperties?: (keyof SetPasswordFormGroupType & string)[] },
    value?: SetPasswordFormGroupType
  ) {
